  ...
  <nav class="navbar navbar-default" id="navbar">
    ...
    <ul class="nav navbar-nav">
      <li v-for="route in routes" v-link-active>
        <a v-link="{path: route.fullPath, exact: route.showInNavbar.exact, activeClass: 'active'}">
    ...
    <ul class="nav navbar-nav navbar-right m-r-5">
      <li data-toggle="tooltip" title="Github">
        <a href="https://github.com/lucky0604" target="_blank">
          <i class="fa fa-github fa-lg"></i>
        </a>
      </li>
      <li data-toggle="tooltip" title="Docs">
