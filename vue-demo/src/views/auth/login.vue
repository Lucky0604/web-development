  ...
  <form @submit.prevent="handleSubmit" class="m-0-auto m-t-100 w-60p">
    <div class="form-group">
      <div class="input-group">
        ...
        <input type="text" v-model="username" required class="form-control" placeholder="仅需输入用户名即可登录">
      </div>
    </div>
    <button type="submit" class="btn btn-block" :class="{'btn-success': username.length}" :disabled="!username.length">
