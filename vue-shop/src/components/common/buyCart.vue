  ...
  <section class="cart_module">
    ...
    <section v-else class="choose_specification">
      <section class="choose_icon_container">
        ...
        <span class="show_chooselise" @click="showChooseLise(foods)">选规格</span>
      </section>
    </section>
  </section>
</template>
...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      /** 
      监听cartList变化，更新当前商铺的购物车信息shopCart，同时返回一个新对象
      */
      shopCart: function() {
    ...
    methods: {
      ...
      // 显示规格列表
      showChooseLise(foodScroll) {
        this.$emit('showChooseLise', foodScroll)
      },
