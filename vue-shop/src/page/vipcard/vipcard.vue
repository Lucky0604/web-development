<template>
  <div class="rating_page">
    ...
    <section v-if="userInfo">
      ...
      <section class="vip_preprogative">
        <route-link class="header_style" to="/vipcard/vipDescription">
        ...
        <section class="vip_detail">
          <div class="vip_detail_left">
            <img src="../../images/sheng.jpeg" alt="" height="80" width="70">
          </div>
        ...
        <section class="vip_detail">
          <div class="vip_detail_left">
            <img src="../../images/jifen.jpeg" alt="" width="70" height="80">
          </div>
          <div class="vip_detail_right">
            <h4>减免配送费</h4>
            <p>
