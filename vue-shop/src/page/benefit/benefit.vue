      ...
      <transition name="router-fade">
        <section v-if="categoryType === 1">
          <section class="hongbao_container">
            <header class="hongbao_title">
              ...
              <section class="hongbao_description">
                <img src="../../images/description.png" alt="" height="24" width="24">
            ...
            <ul class="hongbao_list_ul">
              <li class="hongbao_list_li" v-for="item in hongbaoList" :key="item.id">
                ...
                <footer class="list_item_footer" v-if="item.extra_limit">
                  <ul>
                    <li v-for="(limit, index) in item.extra_limit" :key="index">{{limit}}</li>
                  </ul>
                </footer>
              </li>
            </ul>
          ...
          <footer class="hongbao_footer">
            <router-link class="hongbao_style"  to="/benefit/exchange" style="border-right: 1px solid #f5f5f5;">兑换红包</router-link>
      ...
      <transition name="router-fade">
        <section class="voucher_container" v-if="categoryType === 2">
          ...
          <section class="unable_use">
            <img src="../../images/voucher.png" alt="" height="170" width="300">
            <p>无法使用代金券</p>
            <p>非客户端或客户端版本过低</p>
            <router-link class="download_app">下载或升级客户端</router-link>
          </section>
        </section>
      </transition>
    </section>
