    ...
    <section class="profile-info">
      <section class="headportrait">
        ...
        <div class="headportrait-div">
          <img :src="imgPath" alt="" class="headportrait-div-top" v-if="avatar">
      ...
      <section class="info-router" @click="changePhone">
        <section class="headportrait headportraitwo headportraithree">
          <h2><img src="../../../images/bindphone.png" alt="" style="display: inline-block; margin-right:.4rem;">手机</h2>
          <div class="headportrait-div">
            <span class="headportrait-div-bottom">
              <svg fill="#d8d8d8">
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#arrow-right"></use>
      ...
      <section class="exitlogin" @click="exitlogin">退出登陆</section>
    </section>
      ...
      <section class="cover-content" :class="{'cover-animate': isEnter, 'cover-animate-leave': isLeave}">
        ...
        <div class="sa-button">
          ...
          <div style="display: inline-block;">
            <button class="quitlogin" @click="outLogin">退出登陆</button>
          </div>
        </div>
      </section>
    </section>
      ...
      async uploadAvatar () {
        ...
        if (this.userInfo) {
          ...
          try {
            ...
            this.SAVE_AVATAR(this.getImgPath(res));
          } catch(err) {
            this.showAlert = true;
            this.alertText = '上传失败';
            throw new Error(err);
