  ...
  <div class="profile_page">
    ...
    <section>
      <section class="profile-number">
        <router-link class="profile-link" :to="userInfo? '/profile/info': '/login'">
          <img :src="imgpath" alt="" class="privateImage" v-if="this.avatar">
      ...
      <section class="info-data">
        <ul class="clear">
          <router-link class="info-data-link" to="/balance" tag="li">
            <span class="info-data-top"><b>{{parseInt(balance).toFixed(2)}}</b>元</span>
            <span class="info-data-bottom">我的余额</span>
          </router-link>
          <router-link class="info-data-link" to="/benefit" tag="li">
            <span class="info-data-top"><b>{{count}}</b>个</span>
            <span class="info-data-bottom">我的优惠</span>
          </router-link>
          <router-link class="info-data-link" to="/points" tag="li">
    ...
    ul {
      .info-data-link {
        ...
        .info-data-top {
          ...
          padding: .8533333rem 0 0.45333333rem;
          b {
            display: inline-block;
  ...
  .profile-list {
    ...
    .myorder {
      ...
      .myorder-div {
        ...
        .myorder-divsvg {
          @include wh(0.466667rem, 0.466667rem);
          svg {
            @include wh(100%, 100%);
          }
        }
