      ...
      <section>
        ...
        <section class="shop_status_container">
          ...
          <ul>
            ...
            <li>
              <p>属地监管所</p>
              <p>
                {{shopDetail.identification.registered_principal}}
              </p>
            </li>
            <li>
              <p>法定代表人</p>
        ...
        <section class="license_img shop_status_container">
          ...
          <div class="img_container">
            <img :src="getImgPath(shopDetail.license.business_license_image)" alt="">
            <img :src="getImgPath(shopDetail.license.catering_service_license_image)" alt="">
          </div>
        </section>
      </section>
    </section>
